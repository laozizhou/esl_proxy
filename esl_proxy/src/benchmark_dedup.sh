...
# skipped), and reports median/mean/min/max for the [orchestration]/
# [scheduler]/[cutter]/[total] timing lines each run prints.
#
...
measure() {
    ...
    local orch_time=() orch_tp=() sched_dur=() sched_tp=()
    local cutter_dur=() cutter_tp=() total_time=() total_tp=()
