/*
 * log.c - Scheduler-specific worker log implementation
 *
 * Based on algorithm/log.c but uses common/log.h header.
 * Provides per-thread CSV log output to log/<base>_thread_<N>.csv files.
 */
// #include <stdarg.h>
// #include <stdio.h>
// #include <stdlib.h>
